...
<body>
    ...
    <div class="container-home">
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <h2>Add Data</h2>
                <form id="addDataForm" method="POST" action="crud_detailT.php">
    ...
    <div id="myModalUpdate" class="modalUpdate">
        <div class="modal-contentUpdate">
            ...
            <h2>Update Data</h2>
            <form id="updateDataForm" method="POST" action="crud_detailT.php">
    ...
    <div id="myModalDelete" class="modalDelete">
        <div class="modal-contentDelete">
            ...
            <h2>Delete Data</h2>
            <form id="deleteDataForm" method="POST" action="crud_detailT.php">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function sendData() {
                ...
                formData.append("addData", true); // Add this line to set the correct key

                var xhr = new XMLHttpRequest();
                xhr.open("POST", "./crud_detailT.php", true);
            ...
            function sendDeleteData() {
                ...
                formData.append("deleteData", true); // Add this line to set the correct key
            ...
            function sendUpdateData() {
                ...
                formData.append("editData", true); // Add this line to set the correct key
