...
<body>
    <div class="container-home">
        ...
        <table>
            ...
            <tbody>
                <?php
                require '/xampp/htdocs/website/component/page/crud_detailT.php';
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>{$row['barang_barcode']}</td>";
                    echo "<td>{$row['transaksi_no_struk']}</td>";
                    ...
                    <a href="#" onclick="openModalUpdate(\'' . $row['id_detail_transaksi'] . '\', \'' . $row['total_harga'] . '\',\'' . $row['barang_barcode'] . '\',\'' . $row['transaksi_no_struk'] . '\' )">Update</a>;

                     <a href="#" onclick="openModalDelete(\'' . $row['id_detail_transaksi'] . '\', \'' . $row['total_harga'] . '\')">Delete</a></div></td>';
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <h2>Add Data</h2>
                <form id="addDataForm" method="POST" action="/website/component/page/crud_detailT.php">

                    <label for="id_detail">ID Detail Transaksi:</label>
                    ...
                    <select id="barcode" name="barcode">
                        ...
                        $query_kategori = "SELECT * FROM barang";
                        ...
                        if (!$result_kategori) {
                            ...
                            if (mysqli_num_rows($result_kategori) > 0) {
                                while ($row_kategori = mysqli_fetch_assoc($result_kategori)) {
                                    echo "<option value='{$row_kategori['barcode']}'>{$row_kategori['barcode']}</option>";
                                }
                            } else {
                                echo '<option value="No Data">No Data</option>';
                            }
                    ...
                    <select id="no_struk" name="no_struk">
                        <?php

                        $query_kategori = "SELECT * FROM transaksi";
                        $result_kategori = mysqli_query($conn, $query_kategori);
                        ...
                        if (!$result_kategori) {
                            ...
                            if (mysqli_num_rows($result_kategori) > 0) {
                                while ($row_kategori = mysqli_fetch_assoc($result_kategori)) {
                                    echo "<option value='{$row_kategori['no_struk']}'>{$row_kategori['no_struk']}</option>";
                                }
                            } else {
                                echo '<option value="No Data">No Data</option>';
                            }
    ...
    <div id="myModalUpdate" class="modalUpdate">
        <div class="modal-contentUpdate">
            ...
            <h2>Update Data</h2>
            <form id="updateDataForm" method="POST" action="/website/component/page/crud_detailT.php">
                <input type="hidden" id="idUpdate" name="idUpdate" value="">
                <label for="update_id_detail">ID Detail Transaksi:</label>
                <input type="text" id="update_id_detail" name="update_id_detail" required><br />

                <label for="update_total_harga">Total Harga:</label>
                <input type="text" id="update_total_harga" name="update_total_harga" required><br />

                <label for="update_barcode">No Barcode:</label>
                <select id="update_barcode" name="update_barcode">
                    <?php
                ...
                <label for="update_no_struk">No Struk:</label>
                <select id="update_no_struk" name="update_no_struk">
                    <?php
    ...
    <div id="myModalDelete" class="modalDelete">
        <div class="modal-contentDelete">
            ...
            <h2>Delete Data</h2>
            <form id="deleteDataForm" method="POST" action="/website/component/page/crud_detailT.php">
                <input type="hidden" id="idUpdateDelete" name="idUpdateDelete">
    ...
    <script>
        ...
        function openModalUpdate(idDetail, totalHarga, barcode, struk) {
            document.getElementById('idUpdate').value = idDetail;
            document.getElementById('update_id_detail').value = idDetail;
            document.getElementById('update_total_harga').value = totalHarga;
            document.getElementById('update_barcode').value = barcode;
            document.getElementById('update_no_struk').value = struk;
        ...
        function openModalDelete(id_barang, nama_barang) {
            document.getElementById('idUpdateDelete').value = id_barang;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function sendData() {
                ...
                xhr.open("POST", "/website/component/page/crud_detailT.php", true);
            ...
            function sendDeleteData() {
                var idUpdate = document.getElementById("idUpdateDelete").value;

                fetch("/path/to/crud_detailT.php", { // Ganti dengan path yang benar
                        method: "POST",
