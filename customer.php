...
<body>
    ...
    <div class="container-home">
        ...
        <table>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <a href="#" onclick="openModalUpdate(\'' . $row['id_customer'] . '\', \'' . $row['nama'] . '\',\'' . $row['tanggal_lahir'] . '\',\'' . $row['alamat'] . '\', \'' . $row['no_kontak'] . '\', \'' . $row['gender_id_gender'] . '\' )">Update</a>;

                     <a href="#" onclick="openModalDelete(\'' . $row['id_customer'] . '\', \'' . $row['nama'] . '\')">Delete</a></div></td>';
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <h2>Add Data</h2>
                <form id="addDataForm" method="POST" action="crud_customer.php">
                    ...
                    <label for="no_kontak">No Telepon:</label>
                    <input type="text" id="no_kontak" name="no_kontak" required><br />
                    <label for="id_gender">Gender:</label>
                    <select id="id_gender" name="id_gender">
                        <?php

                        $query_kategori = "SELECT * FROM gender";
                        ...
                        if (!$result_kategori) {
                            ...
                            if (mysqli_num_rows($result_kategori) > 0) {
                                while ($row_kategori = mysqli_fetch_assoc($result_kategori)) {
                                    echo "<option value='{$row_kategori['id_gender']}'>{$row_kategori['gender']}</option>";
                                }
                            } else {
                                echo '<option value="No Data">No Data</option>';
                            }
                    ...
                    <button type="submit" name="addDataCus">Submit</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div id="myModalUpdate" class="modalUpdate">
        <div class="modal-contentUpdate">
            ...
            <h2>Update Data</h2>
            <form id="updateDataForm" method="POST" action="crud_customer.php">
                <input type="hidden" id="idUpdateCus" name="idUpdateCus" value="">

                <label for="id_customer_update">ID Customer:</label>
                <input type="text" id="id_customer_update" name="id_customer_update" required><br />
                ...
                <input type="date" id="tanggal_lahir_update" name="tanggal_lahir_update" required><br />
                <label for="alamat_update">Alamat:</label>
                <input type="text" id="alamat_update" name="alamat_update" required><br />
                <label for="no_kontak_update">No Telepon:</label>
                <input type="text" id="no_kontak_update" name="no_kontak_update" required><br />
                <label for="id_gender_update">Gender:</label>
                <select id="id_gender_update" name="id_gender_update">
                    <?php
                ...
                <button type="submit" name="editDataCus">Update</button>
            </form>
        </div>
    </div>
    <div id="myModalDelete" class="modalDelete">
        <div class="modal-contentDelete">
            ...
            <h2>Delete Data</h2>
            <form id="deleteDataForm" method="POST" action="crud_customer.php">
                <input type="hidden" id="idUpdateCustomer" name="idUpdateCustomer">
                <h1>Apakah Benar ingin di hapus?</h1>
                <span>Nama : <h1 id="delete_nama_barang"></h1></span>
                <button type="submit" id="deleteDataButton" name="deleteDataCus">Submit</button>
            </form>
        </div>
    </div>
    </div>
    ...
    <script>
        ...
        function openModalUpdate(idDetail, nama, tanggal, alamat, no, gender) {
            document.getElementById('idUpdateCus').value = idDetail;
            document.getElementById('id_customer_update').value = idDetail;
            document.getElementById('nama_update').value = nama;
            document.getElementById('tanggal_lahir_update').value = tanggal;
            document.getElementById('alamat_update').value = alamat;
            document.getElementById('no_kontak_update').value = no;
            document.getElementById('id_gender_update').value = gender;
        ...
        function openModalDelete(id_barang, nama_barang) {
            document.getElementById('idUpdateCustomer').value = id_barang;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function sendData() {
                ...
                formData.append("addDataCus", true); // Add this line to set the correct key

                var xhr = new XMLHttpRequest();
                xhr.open("POST", "./crud_customer.php", true);
            ...
            function sendDeleteData() {
                ...
                formData.append("deleteDataCus", true); // Add this line to set the correct key
            ...
            function sendUpdateData() {
                ...
                formData.append("editDataCus", true); // Add this line to set the correct key
